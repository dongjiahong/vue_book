...
export default {
  getFeatureData() {
    return async (apiUrl + '/recommendPage/nodes/5910018c8094b1e228e5868f').then(data => data.data)
  },

  getBooks(id) {
    return async (apiUrl + '/recommendPage/books/' + id).then(data => data.data)
  },
  ...
  getRecommend(id) {
    return async (apiUrl + '/book/' + id + '/recommend').then(data => data.books)
  },
